...
public class TimerCalculate {
    ...
    public void StartProcess() {
        if (this.int_stateValue == 0) {
            ...
            startCountDown(Long.parseLong(this.obj_Environment
                    .SearchValue("Countdown/Min30")));
    ...
    private class MyCoundDownTask extends CountDownTimer {
        ...
        public void onTick(long millisUntilFinished) {
            ...
            long minus = millisUntilFinished
                    / (Long.parseLong(obj_Environment
                            .SearchValue("TimeDefinition/Min")));
            long seconds = (millisUntilFinished % (Long
                    .parseLong(obj_Environment
                            .SearchValue("TimeDefinition/Min"))))
                    / (Long.parseLong(obj_Environment
